...
class WebXiaomiSocialSource:
    ...
    def fetch_items(self) -> Iterator[Item]:
        ...
        table.get("https://xiaomi.jobs.f.mioffice.cn/index/")
        ...
        while True:
            ...
            for item in res_list:
                t = Item(
                    ...
                    work_type="社招",
                    job_url=f"https://xiaomi.jobs.f.mioffice.cn/index/position/{item.get('id', uuid.uuid4())}/detail",
