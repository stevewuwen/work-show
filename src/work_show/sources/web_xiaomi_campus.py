...
class WebXiaomiCampusSource:
    ...
    def fetch_items(self) -> Iterator[Item]:
        ...
        table.get("https://xiaomi.jobs.f.mioffice.cn/campus/")
        ...
        while True:
            ...
            for item in res_list:
                t = Item(
                    ...
                    work_type="校招",
                    job_url=f"https://xiaomi.jobs.f.mioffice.cn/campus/position/{item.get('id', uuid.uuid4())}/detail",
